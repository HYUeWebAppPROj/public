...
<html lang="en">
    <head>
      ...
      rel="stylesheet">
        ...
        <?php echo e(HTML::style('css/userpage.css')); ?>

        <?php echo e(HTML::style('css/nav_userpage.css')); ?>
        ...
        <?php echo e(HTML::style('css/snackbar.css')); ?>

    </head>
    <body ng-app="userApp" ng-controller="MainCtrl" data-ng-init="initApp()">
        <header>
            <?php echo $__env->make("mpgnav_userpage", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </header>
        <section class="content-view flex-layout-md flex-layout-md-horizontal flex-layout-lg flex-layout-lg-horizontal flex-layout-xlg flex-layout-xlg-horizontal">
            ...
            <div class="flex-item-md-lv1 flex-item-lg-lv1 flex-item-xlg-lv1 shopcart">
				...
				<div class="user-icon-container">
					<img style="height:auto;width:100%;" src='<?php echo e(Session::get("logininfo")["avatar"]); ?>'>
				</div>
    ...
    -->
        ...
        <?php echo e(HTML::script('js/snackbarutil.js')); ?>
